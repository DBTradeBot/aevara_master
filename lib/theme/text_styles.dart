...
class AevaraText {
  ...
  static TextTheme textTheme(Brightness brightness) {
    ...
    return base.copyWith(
      ...
      displaySmall: base.displaySmall?.copyWith(fontSize: 28, height: 34 / 28, fontWeight: _wSmb),
      headlineMedium: base.headlineMedium?.copyWith(fontSize: 22, height: 28 / 22, fontWeight: _wSmb),
      headlineSmall: base.headlineSmall?.copyWith(fontSize: 18, height: 24 / 18, fontWeight: _wMed),

      // Titles (used widely in cards/tiles/toolbars)
      titleLarge: base.titleLarge?.copyWith(fontSize: 22, height: 28 / 22, fontWeight: _wSmb),
      titleMedium: base.titleMedium?.copyWith(fontSize: 15, height: 22 / 15, fontWeight: _wMed), // TILE VALUES
      titleSmall: base.titleSmall?.copyWith(fontSize: 13, height: 18 / 13, fontWeight: _wMed),

      // Body
      bodyLarge: base.bodyLarge?.copyWith(fontSize: 15, height: 22 / 15, fontWeight: _wReg),
      bodyMedium: base.bodyMedium?.copyWith(fontSize: 15, height: 22 / 15, fontWeight: _wReg),
      bodySmall: base.bodySmall?.copyWith(fontSize: 12, height: 16 / 12, fontWeight: _wReg),

      // Labels (buttons/chips)
      labelLarge: base.labelLarge?.copyWith(fontSize: 13, height: 18 / 13, fontWeight: _wMed),
      labelMedium: base.labelMedium?.copyWith(fontSize: 12, height: 16 / 12, fontWeight: _wMed),
      labelSmall: base.labelSmall?.copyWith(fontSize: 11, height: 14 / 11, fontWeight: _wMed),
    );
  }
}
...
extension AevaraTextX on BuildContext {
  ...
  TextStyle get label => _tt.titleSmall!;  // 13/18 medium (used for compact labels)
