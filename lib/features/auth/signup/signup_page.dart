...
class _SignUpPageState extends State<SignUpPage>{ final name=TextEditingController(); final email=TextEditingController(); final pass=TextEditingController(); final confirm=TextEditingController();
  @override Widget build(BuildContext c)=>Scaffold(appBar: AppBar(title: const Text('Create account (1/4)')), body: ListView(padding: const EdgeInsets.all(16), children:[
    ...
    FilledButton(onPressed: ()=>Navigator.pushNamed(c, Routes.obBasics), child: const Text('Next: Basics')),
  ]));
}
