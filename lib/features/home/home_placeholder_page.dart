...
class HomePlaceholderPage extends StatelessWidget{
  ...
  @override Widget build(BuildContext c)=>AppShell(currentIndex:0, title:'Home', body: ListView(padding: const EdgeInsets.all(16), children:[
    Row(children:[ Expanded(child: Card(child: ListTile(title: const Text('Welcome back'), subtitle: const Text('Coach tip: small steps daily')))), const SizedBox(width:12), const AeProgressRing(value:.62, label:'Weekly Goal') ]),
