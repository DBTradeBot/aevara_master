class Routes {
  ...
  // Onboarding (legacy aliases used by some files)
  static const onboardingBasics = '/onboarding/basics';
  ...
  // Settings (legacy aliases used by some files)
  static const account          = '/settings/profile';
  static const devices          = '/settings/devices';
  static const privacy          = '/settings/privacy';
  static const security         = '/settings/security';

  // Generic/profile/about
