                  ...
                  SizedBox(
                    ...
                    child: Card(
                      child: InkWell(
                        ...
                        onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (_)=> _ExperimentDetail(title: e.$1, category: e.$2, duration: e.$3, tracks: e.$4))),
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(e.$1, style: Theme.of(context).textTheme.labelLarge),
                              const SizedBox(height: 4),
                              Text(e.$2, style: Theme.of(context).textTheme.bodySmall),
                              const SizedBox(height: 12),
                              Text(e.$3),
                              const SizedBox(height: 8),
                              Wrap(spacing: 6, children: [for (final t in e.$4) Chip(label: Text(t))]),
                            ],
                          ),
                        ),
                      ),
...
class _ExperimentDetail extends StatelessWidget {
  ...
  const _ExperimentDetail({required this.title, required this.category, required this.duration, required this.tracks});
        ...
        child: Column(
          ...
          children: [
            ...
            FilledButton(onPressed: (){
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Experiment started (stub).')));
