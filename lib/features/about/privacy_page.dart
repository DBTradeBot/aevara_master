      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(body, style: t.bodyMedium!.copyWith(color: cs.onSurface.withOpacity(.75))),
          ],
        ),
      ),
    );
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: t.bodyMedium!.copyWith(color: cs.onSurface.withOpacity(.75)),
                          ),
                        ],
                      ),
                    ),
