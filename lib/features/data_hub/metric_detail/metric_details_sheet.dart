        ...
        child: Column(
            ...
            children: [
              ...
              const ListTile(
                  title: Text('Insights'),
                  subtitle:
                      Text('Consistency improving; keep bedtime before 11pm.')),
              const SizedBox(height: 8),
              ...
              Table(columnWidths: const {
                ...
                ...['Oura', 'Apple', 'Fitbit'].map((p) => TableRow(children: [
                      ...
                      const Padding(
                          padding: EdgeInsets.all(6), child: Text('--')),
                      const Padding(
                          padding: EdgeInsets.all(6),
                          child: Text('Today 07:10')),
                    ]))
              ]),
              const SizedBox(height: 8),
              const ExpansionTile(title: Text('Why this value?'), children: [
                ListTile(title: Text('Priority rule: Oura > Apple > Fitbit'))
              ]),
              const SizedBox(height: 8),
              const ListTile(
                  title: Text('Per-day sources (14d)'),
                  subtitle: Text('UI placeholder')),
              const SizedBox(height: 12),
            ]));
  }
}
