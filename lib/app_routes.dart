...
// ✅ Correct path to the constants file
...
import 'features/settings/account/update_profile_page.dart';
...
final Map<String, WidgetBuilder> appRoutes = <String, WidgetBuilder>{
  ...
  RoutePaths.updateProfile: (_) => const UpdateProfilePage(),
