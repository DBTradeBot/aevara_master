          ...
          Expanded(
              child: Card(
                  child: ListTile(
                      ...
                      subtitle: Text('Coach tip: small steps daily')))),
          SizedBox(width: 12),
          AeProgressRing(value: .62, label: 'Weekly Goal')
        ]),
        const SizedBox(height: 16),
        const AeListSectionHeader(title: 'Shortcuts'),
        Wrap(spacing: 8, runSpacing: 8, children: [
          FilledButton(
              onPressed: () => Navigator.pushNamed(c, Routes.dataHub),
              child: const Text('Data Hub')),
          OutlinedButton(
