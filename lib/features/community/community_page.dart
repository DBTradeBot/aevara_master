      ...
      itemBuilder: (_, i) {
        ...
        return Card(
            child: ListTile(
                title: Text(c.$1),
                subtitle: Text(c.$2),
                trailing: FilledButton(onPressed: () {}, child: Text(c.$3))));
      },
    );
  }
}
...
class _LeaderboardsTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final rows = List.generate(10,
        (i) => ('#${i + 1}', '@user${i + 1}', '${(10000 - i * 432)} steps'));
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        ...
        Card(
          ...
          for (final r in rows)
            ListTile(
                leading: Text(r.$1), title: Text(r.$2), trailing: Text(r.$3))
        ])),
      ],
    );
  }
      ...
      children: [
        const TextField(
            decoration: InputDecoration(
                prefixIcon: Icon(Icons.search), hintText: 'Search users')),
        const SizedBox(height: 12),
        Card(
            child: Column(children: [
          for (final f in friends)
            ListTile(
                ...
                trailing: Wrap(spacing: 8, children: [
                  OutlinedButton(onPressed: () {}, child: const Text('Cheer')),
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, i) {
        ...
        return Card(
            child: ListTile(
                title: Text(g),
                subtitle: const Text('Weekly leaderboard â€¢ 128 members'),
                trailing:
