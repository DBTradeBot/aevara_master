...
class AevTextStyles {
  static TextTheme buildTextTheme(
      TextTheme base, Color colorPrimary, Color colorSecondary) {
    ...
    return t.copyWith(
      ...
      headlineSmall: t.headlineSmall?.copyWith(
          fontSize: 18, fontWeight: FontWeight.w600, height: 26 / 18),
      bodyLarge: t.bodyLarge?.copyWith(
          fontSize: 16, fontWeight: FontWeight.w400, height: 24 / 16),
      bodyMedium: t.bodyMedium?.copyWith(
          fontSize: 14, fontWeight: FontWeight.w400, height: 22 / 14),
      labelLarge:
          t.labelLarge?.copyWith(fontSize: 14, fontWeight: FontWeight.w600),
      labelMedium:
          t.labelMedium?.copyWith(fontSize: 13, fontWeight: FontWeight.w500),
    );
  }
}
